"""
main source : https://github.com/MarvinTeichmann/ConvCRF
The MIT License (MIT)

Copyright (c) 2017

modified by mahyar pedram
"""
...
def do_crf_inference(image, unary, normalize=False):
    ...
    result =  prediction.data.cpu().numpy()

    final = result[0]  # Remove Batch dimension
    finalHard = np.argmax(final, axis=0)
    return (finalHard*255).astype(np.uint8)
